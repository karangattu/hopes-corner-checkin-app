...
import { useFadeInUp, useScaleIn, useStagger, iconHoverProps, SpringIcon } from '../animations';
...
describe('animations', () => {
  ...
  it('iconHoverProps has correct className', () => {
    expect(iconHoverProps.className).toBe('transition-transform duration-200 will-change-transform hover:scale-110');
  });
  ...
  it('SpringIcon renders with animated span', () => {
    ...
    expect(span).toHaveClass('inline-flex', 'items-center', 'justify-center', 'will-change-transform');
  });
});
